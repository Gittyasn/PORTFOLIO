        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              {/* Email details */}
              <a
                href="mailto:yaswanth.dev@gmail.com"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-foreground/90 break-all">yaswanth.dev@gmail.com</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 bg-card border border-border p-5 rounded-2xl shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-foreground/90">+91 XXXXXXXXXX</p>
                </div>
              </div>
